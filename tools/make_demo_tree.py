...
frueh verstorbenes Kind, Gefallene, Auswanderer, Scheidung, unbekannte Mutter, Quellen, Notizen,
Orte mit Koordinaten, Medien an Personen und Familien.
...
PEOPLE = [
    ...
    P('I25', 'Otto', 'Falkenrath', 'M', ('22 MAR 1930', 'Celle'), ('3 SEP 2008', 'Milwaukee'), occu='Werkzeugmacher', portrait='m-1955b',
      ...
      note='Wanderte 1952 nach Amerika aus und nannte sich dort „Otto Falkenrath“ ohne Änderung der Schreibweise.'),
    ...
    P('I54', 'Hans Jürgen', 'Falkenrath', 'M', ('ABT 1770', 'Eschede'), ('11 DEC 1831', 'Eschede'), occu='Häusling',
      note='Ältester bekannter Träger des Namens. Seine Frau wird im Taufeintrag des Sohnes nicht genannt.'),
]
...
FAMILIES = [
    ...
    ('F7', 'I19', 'I20', ('15 JUN 1956', 'Lueneburg'), ['I9', 'I14'], None, None),
    ...
    ('F12', 'I30', 'I31', ('21 APR 1922', 'Lueneburg'), ['I19'], None, None),
    ('F13', 'I32', 'I33', ('12 OCT 1928', 'Lueneburg'), ['I20', 'I34'], None, None),
    ('F14', 'I36', 'I35', ('2 JUN 1953', 'Uelzen'), ['I37'], None, None),
    ('F15', 'I39', 'I40', ('14 SEP 1893', 'Celle'), ['I41', 'I21'], None, None),
    ('F16', 'I42', 'I43', ('8 MAY 1896', 'Celle'), ['I22', 'I38'], None, None),
    ('F17', 'I44', 'I45', ('19 NOV 1891', 'Uelzen'), ['I28'], None, None),
    ('F18', 'I46', 'I47', ('3 FEB 1890', 'Lueneburg'), ['I30'], None, None),
    ('F19', 'I48', 'I49', ('26 OCT 1862', 'Celle'), ['I39'], None, None),
    ('F20', 'I50', 'I51', ('30 APR 1866', 'Celle'), ['I40'], None, None),
    ('F21', 'I52', 'I53', ('15 NOV 1829', 'Eschede'), ['I48'], None, None),
    ('F22', 'I54', None, None, ['I52'], None, None),
]
...
def build_media(media):
    ...
    document(MEDIA / 'familienbibel.jpg', 'Familien-Chronik', [
        ...
        'in den Stand der Ehe getreten.', '', 'Unsere Kinder:', '1866 den 19ten November  Carl', '', 'Gott segne unser Haus.',
    ], seed=14)
